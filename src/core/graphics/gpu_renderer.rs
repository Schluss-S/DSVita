...
use crate::presenter::{Presenter, PresenterScreen, PRESENTER_SCREEN_HEIGHT, PRESENTER_SCREEN_WIDTH, PRESENTER_SUB_REGULAR, PRESENTER_SUB_RESIZED, PRESENTER_SUB_RESIZED_INV, PRESENTER_SUB_ROTATED, SWAP_ZONE};
...
impl GpuRenderer {
    ...
    pub fn render_loop(&mut self, presenter: &mut Presenter, fps: &Arc<AtomicU16>, last_save_time: &Arc<Mutex<Option<(Instant, bool)>>>, settings: &Settings, swap_sizes: bool) {
        ...
        unsafe {
            ...
            {
                let swap_zone_x = (PRESENTER_SCREEN_WIDTH - SWAP_ZONE - 4) as f32;
                let swap_zone_y = 4 as f32;
                self.gl_rectangle.draw_filled_stroke(swap_zone_x, swap_zone_y, SWAP_ZONE as f32, SWAP_ZONE as f32,
